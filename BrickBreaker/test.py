...
def initial_settings(root):
    ...
    reward_types = ["Constant", "Time-Based", "X-Distance", "X-Distance(Center)"]
    ...
    random = create_spinbox(win, -1, 1, 1, IntVar(value=0), 3, 26)
...
def experiment_tuning(root):
    ...
    best = create_spinbox(win, 1, 10, 1, IntVar(value=5), 6, 11, "Best")
