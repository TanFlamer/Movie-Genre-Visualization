...
There are 4 distinct files provided: main.py and
3 packages named code, gui and others. The GUI
is run by running the code inside main.py.
...
The last package is named other. The files within
control other miscellaneous processes.
